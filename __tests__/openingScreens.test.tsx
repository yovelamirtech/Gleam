...
// TapToStartScreen's decorative sparkles are StoneIcon's, which need a
// native Skia surface the test renderer doesn't have - same reasoning as
// BoardScreen.test.tsx's mock.
